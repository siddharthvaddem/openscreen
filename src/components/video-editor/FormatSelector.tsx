				...
				return (
					<button
						...
						className={cn(
							...
							"focus:outline-none focus:ring-2 focus:ring-[#34B27B]/50 focus:ring-offset-2 focus:ring-offset-background",
							isSelected
								? "bg-[#34B27B]/10 border-[#34B27B]/50 text-foreground"
								: "bg-background border-input editor-text-muted hover:bg-accent hover:border-border hover:text-foreground",
					...
					>
						<div
							className={cn(
								...
								isSelected ? "bg-[#34B27B]/20 text-[#34B27B]" : "bg-muted",
							)}
						>
							{option.icon}
						</div>
						<div className="text-center">
							...
							<div className="text-xs editor-text-faint mt-0.5">{labels.description}</div>
						</div>
						{isSelected && (
