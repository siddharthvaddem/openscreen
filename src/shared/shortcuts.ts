// Shared shortcuts types and utilities — pure TypeScript, no browser dependencies.
// Original source: src/lib/shortcuts.ts
// NOTE: matchesShortcut() is NOT included here because it uses browser KeyboardEvent.
