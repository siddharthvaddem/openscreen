// Shared editor types — pure TypeScript, no browser dependencies.
// Original source: src/components/video-editor/types.ts

export type ZoomDepth = 1 | 2 | 3 | 4 | 5 | 6;
export type ZoomFocusMode = "manual" | "auto";

// Inlined from compositeLayout.ts to avoid importing browser-dependent module
...
export function clampFocusToDepth(focus: ZoomFocus, _depth: ZoomDepth): ZoomFocus {
	return {
		cx: clampFocusValue(focus.cx),
		cy: clampFocusValue(focus.cy),
	};
}
